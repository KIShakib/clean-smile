...
const Footer = () => {
    return (
        <div className='bg-cover pt-24' style={{ backgroundImage: `url(${wave})` }}>
            <div className='lg:w-[90%] mx-auto pb-5'>
                <footer className="footer p-10 bg-transparent text-base-content font-semibold" >
                    <div>
                ...
                <footer className="footer px-10 py-4 text-base-content">
                    <div className="items-center grid-flow-col">
                        ...
                        <p><span className='text-4xl' style={{ fontFamily: "'Kaushan Script', cursive" }}>Clean Smile Dental Care</span> <br />Giving Dental Health Since 2005</p>
                    </div>
